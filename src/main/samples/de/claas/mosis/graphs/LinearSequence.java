...
/**
 * The class {@link LinearSequence} is a sample demonstrator. It is intended to
 * show the use of a (simple) sequential information flow. Here the basic
 * sequence is based on two {@link Processor} objects only (i.e. a source and a
 * sink).
 * 
