...
public abstract class Utils {
     ...
     * 
     * @param representables
     *            the initial {@link Set} of {@link Node}s used to look for data
     *            sources
     ...
     * 
     * @param clazz
     *            the {@link Class} that the instance will have
     * @param args
     *            the arguments that are used to create the
     * @return an instance of a class
     * @throws Exception
     *             if the class could not be instantiated (e.g. not matching
