...
public class Graph {
     ...
     * 
     * @param clazz
     *            the {@link Iterator} class that should be instantiated
     * @return an instantiated {@link Iterator} object of the given
     *         {@link Class} for this graph
     * @throws ReflectiveOperationException
     *             If the {@link Iterator} class could not be properly
     *             instantiated.
     */
