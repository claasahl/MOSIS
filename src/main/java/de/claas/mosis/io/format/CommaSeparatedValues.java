...
public class CommaSeparatedValues extends AbstractTextFormat<Data> {
    ...
    @Parameter("Header used during input / output operations. Can be used selectively write data.")//TODO Can be used selectively read and write data. ???
     ...
     * @param index
     *            index of attribute whose name is returned.
     ...
     * 
     * @param csv
     *            the CSV data that is being processed
     * @param header
     *            true, if the first line of CSV data should be interpreted as
     ...
     *            the CSV data that is being processed
     * @param attributes
     *            the column headers. If there are more columns then column
     ...
     * 
     * @param data
     *            the CSV object that should be returned as CSV data
     * @param attributes
     *            the attributes that should be in the CSV data
