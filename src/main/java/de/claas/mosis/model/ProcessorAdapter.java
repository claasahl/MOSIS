...
/**
 * The class {@link de.claas.mosis.model.ProcessorAdapter}. It is a partial implementation of the
 * {@link Processor} interface. This {@link de.claas.mosis.model.Processor} covers parameter related
 * methods and provides some convenience functions. A default implementation for
...
public abstract class ProcessorAdapter<I, O> extends ConfigurableAdapter
     ...
     * meant to be used inside {@link de.claas.mosis.model.Processor#process(java.util.List, java.util.List)} to see whether
     * any data has been passed to it or not.
     *
     * @param data the data passed to {@link de.claas.mosis.model.Processor#process(java.util.List, java.util.List)}
