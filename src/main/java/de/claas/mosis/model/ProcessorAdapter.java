...
/**
 * The class {@link ProcessorAdapter}. It is a partial implementation of the
 * {@link Processor} interface. This {@link Processor} covers parameter related
...
public abstract class ProcessorAdapter<I, O> extends ConfigurableAdapter
     ...
     * meant to be used inside {@link Processor#process(java.util.List, java.util.List)} to see whether
     * any data has been passed to it or not.
     *
     * @param data the data passed to {@link Processor#process(java.util.List, java.util.List)}
