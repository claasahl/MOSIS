...
/**
 * The JUnit test for class {@link de.claas.mosis.flow.iterator.OneShotLevelOrder}.
 ...
 */
public class OneShotLevelOrderTest extends IteratorTest {

    @Override
    public Iterator<Node> build(Collection<Node> sources) {
        return new OneShotLevelOrder(new HashSet<>(sources));
    }
