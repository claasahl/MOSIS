...
/**
 * The JUnit test for class {@link de.claas.mosis.model.Condition.IsLessThan}.
...
public class IsLessThanTest {
    ...
    /**
     * Returns an instantiated {@link de.claas.mosis.model.Condition.IsLessThan}
     * class. If appropriate, the instance is configured with default values as
     * well as the given parameters.
     *
     * @param threshold the threshold
     * @return an instantiated {@link de.claas.mosis.model.Condition.IsLessThan}
     * class
     */
